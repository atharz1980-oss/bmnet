...
المنتج CMS ومجتمع، وإليه أُضيف تسجيل ذاتي في الدورات: تسجيل مجاني، ودفع مستضاف عبر ميسر **في وضع الاختبار وحده**، وحجز مقاعد للدفعات المجدولة. لا تحصيل حقيقي بعد: لا مفاتيح إنتاج ولا دفعة واحدة حقيقية، ووجود إعدادات مزوّد لا يعني تفعيله. و«مسجلون يدويًا» في اللوحة يبقى ما تُدخله الإدارة، منفصلًا عن تسجيلات الموقع.
...
| التسجيل الذاتي وحجز المقاعد | منفذ: مقعد ذرّي بقفل صفّي، ولقطة مالية للدفعة، وحرّاس حذف وسعة |
| الدفع الإلكتروني | ميسر **اختبار فقط**؛ لا مفاتيح حية ولا دفعة حقيقية. Tabby وTamara خارج النطاق |
| التكاملات الخارجية الأخرى | غير منفذة، خارج النطاق الحالي |
