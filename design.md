...
## 7) لوحة التحكم (Phase 2 — قواعد خاصة)
...
- **Topbar:** Breadcrumbs + بحث + Notifications placeholder + Profile placeholder.
...
- الرفع في لوحة التحكم **Mock**: `URL.createObjectURL` معاينة محلية فقط، لا تخزين.
